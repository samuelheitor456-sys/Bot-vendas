    ...
    if (interaction.customId === 'modal_produto') {
      ...
      db.run(`INSERT INTO produtos (nome, descricao, valor, link, imagem, canal_id) VALUES (?, ?, ?, ?, ?, ?)`,
        ...
        function(err) {
          ...
          // Embed do produto com campos inline e títulos curtos
          const embed = new EmbedBuilder()
            ...
            .setImage(imagem)
            .setFooter({ text: `BOT DE VENDAS SLZ SHOOP | Hoje às ${new Date().toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}` })
            .setTimestamp();
